...
import { LiveOperationalDashboardV132 } from '../components/noc/LiveOperationalDashboardV132';
import { NOCStatusWidgetV132 } from '../components/noc/NOCStatusWidgetV132';
import { NOCMiniWidgetSnippet } from '../components/noc/NOCMiniWidgetSnippet';
import { useGetCyclesBalance } from '../hooks/useQueries';
...
export default function NOCPage() {
  ...
  const { data: cyclesBalance } = useGetCyclesBalance();
  ...
  return (
    <div className="min-h-screen bg-kd-bg text-kd-text noc-page-container">
      {/* NOC Status Widget - Sticky Top Right */}
      <NOCStatusWidgetV132
        aiStatus={aiStatus}
        treasuryStatus={treasuryStatus}
        omniMeshStatus={omniMeshStatus}
        universalLaunchState={universalLaunchState}
      />

      <div className="container py-8 space-y-8">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-bold text-kd-neon">KD.WebAI NOC V13.2</h1>
            <p className="text-kd-text-muted mt-2">
              Network Operations Center - Full Dashboard Deployment for Institutional Review and DevOps Monitoring
            </p>
          </div>
          <Button
            variant="outline"
        ...
        {/* Embedded NOC Mini Widget - Page-specific instance */}
        <div className="noc-page-mini-widget-container">
          <NOCMiniWidgetSnippet />
        </div>

        {/* V13.2 Live Operational Dashboard - Prominently Positioned */}
        <LiveOperationalDashboardV132
          aiStatus={aiStatus}
          treasuryStatus={treasuryStatus}
          omniMeshStatus={omniMeshStatus}
